        ...
        for idx, line in enumerate(tqdm(lines)):
            ...
            try:
                with torch.no_grad():
                    ...
                    result = model.decode([src_embs[0], src_embs[1], src_embs[2], src_embs[3], src_embs[4]], n_timesteps=args.n_timesteps, temperature=args.temperature, feature_len=src_len)
