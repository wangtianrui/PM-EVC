...
@dataclass
class ScaledAdamConfig(FairseqDataclass):
...
@register_optimizer("scaled_adam", dataclass=ScaledAdamConfig)
class ScaledAdamOptimizer(FairseqOptimizer):
    """
    A fairseq wrapper for sacled adam optimizer
    """
    def __init__(self, cfg: ScaledAdamConfig, params):
        super().__init__(cfg)
        self._optimizer = ScaledAdam(params, **self.optimizer_config)
